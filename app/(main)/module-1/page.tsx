...
// import legalProcessSVG from "@/public/election-board.svg";
...
//       className="shadow-[inset_0px_0px_2px_rgba(0,0,0,0.2)] border border-neutral-300 px-10 text-brand-blue h-161.25 w-full py-8 flex flex-col justify-center"
//     >
//       <div
...
//           <div ref={svgImgRef} className="opacity-0">
...
//           className="w-full h-0 flex flex-col justify-around"
//         >
//           {optionsData.map((option, index) => (
//             <div
//               ref={optionRef}
//               key={index}
//               className={`p-4 border rounded-sm flex items-center gap-x-4 cursor-pointer transition-all duration-200 bg-white border-neutral-200 hover:border-neutral-400 hover:shadow-xs opacity-0`}
//             >
//               {/* Icon */}
...
//               {/* Option Text */}
//               <p className="text-sm sm:text-base font-bold text-[#1A2B56] leading-snug">
//                 {option.text}
//               </p>
//             </div>
//           ))}
...
import certifySVG from "@/public/certify.svg";
import electionBoardSVG from "@/public/election-board.svg";
import legalProcessSVG from "@/public/legal-process.svg"; // Swap with your legal icon SVG when ready

// Import your correct / incorrect SVGs here:
import incorrectSVG from "@/public/incorrect.svg"; // Make sure to add your incorrect SVG path
import correctSVG from "@/public/correct.svg"; // Make sure to add your correct SVG path

gsap.registerPlugin(useGSAP);

// Options Data with Feedback for Screens 5, 6, & 7
const optionsData = [
  {
    id: "certify",
    text: "Certify it — the winner was declared and the loser has conceded",
          ...
          {optionsData.map((option, index) => {
            ...
            return (
              <div
                ...
                className={`p-4 border rounded-sm cursor-pointer transition-all duration-300 ease-in-out shadow-xs ${
                  isSelected
                    ? option.type === "error"
